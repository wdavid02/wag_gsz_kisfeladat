...
```
``` r
git clone https://github.com/sze-info/wag_gsz_kisfeladat
```
...
ROS 2 pacage template, to get started, use template by clicking on the Green button labeled [`Use this template`](https://github.com/sze-info/wag_gsz_kisfeladat/generate) / [`Create new repository`](https://github.com/sze-info/wag_gsz_kisfeladat/generate). 
...
- `wag_gsz_kisfeladat` >> `cool_ros2_package` (the folder was already renamed after `Use this template`)
